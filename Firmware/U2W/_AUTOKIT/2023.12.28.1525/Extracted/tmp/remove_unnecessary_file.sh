...
remove_module_file $support_product $file_list
#remove mtp/adb
support_product="UC2W,UC2HW,UC2HC,UC2AW,UC2F,UC2D,UC2WD,UC2HWD,UC2HCD,U2AC,O2W,"
file_list="/usr/sbin/mtp-server,/usr/sbin/adbd,/usr/sbin/am"
remove_module_file $support_product $file_list
#remove echoDelayTest/car_logo
support_product="UC2W,UC2HW,UC2HC,UC2WD,UC2HCD,UC2HWD,"
file_list="/usr/sbin/echoDelayTest,/etc/DTMF-14809414327.pcm,/etc/car_logo"
remove_module_file $support_product $file_list
#remove hichain
support_product="A15HW,A15W,U2HW,U2HC,UC2HW,UC2HC,UC2HCD,UC2HWD,"
