...
test -e /tmp/.keep_usb_role_when_reboot || test -e /usr/sbin/fakeiOSDevice && echo 0 > /sys/bus/platform/devices/ci_hdrc.1/inputs/b_bus_req && echo "change USB to device mode" >> /dev/console
